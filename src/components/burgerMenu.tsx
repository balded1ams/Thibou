...
const BurgerMenu: React.FC<BurgerMenuProps> = ({
    ...
    return (
      <>
        ...
        {isMenuOpen && (
          <div
            className="fixed left-0 top-0 z-50 flex h-full w-full items-center justify-center drop-shadow-lg backdrop-blur-lg"
                ...
                >
                  ...
                  >
                    <img
                      ...
                      alt="User Avatar"
                      className="ml-3 h-10 w-10 rounded-full border object-cover"
                      style={{
                  ...
                  <button
                    className="text-red-600 flex w-full items-center gap-2 rounded-lg px-4 py-2 text-sm hover:opacity-90"
                    style={{
                      backgroundColor: systemTheme.background.primary,
                    }}
